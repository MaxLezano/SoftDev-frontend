...
function Input({ classNameInput, nameInput, typeInput, idInput, labelText, onChangeInput }) {
  ...
  return (
    <div className='cont-input'>
      <label>
        ...
        <input className={classNameInput} type={typeInput} name={nameInput} id={idInput} onChange={onChangeInput} />
      </label>
    </div>
  );
}
